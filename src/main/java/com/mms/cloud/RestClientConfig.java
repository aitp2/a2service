...
import com.mms.cloud.search.response.aggregations.AggregationDeserializer;
import com.mms.cloud.search.response.aggregations.AggregationKeyDeserializer;
import com.mms.cloud.search.response.aggregations.metric.SingleValueMetricsAggregation;
import com.mms.cloud.search.response.aggregations.bucket.DateHistogramAggregation;
import com.mms.cloud.search.response.aggregations.bucket.HistogramAggregation;
...
public class RestClientConfig {
    ...
    public void configObjectMapper(ObjectMapper objectMapper) {
        ...
        SimpleModule module = new SimpleModule("AggregationDeserializer",
                new Version(1, 0, 0, null, "com.mms.cloud", "aggregation-elastic"));
